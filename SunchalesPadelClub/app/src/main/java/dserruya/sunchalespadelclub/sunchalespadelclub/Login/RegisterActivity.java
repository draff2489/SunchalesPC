...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText mEmail, mPassword, mUsername, mPassword2;
    ...
    private void init() {
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkInputs(email, username, password, password2)) {
    ...
    private boolean checkInputs(String email, String username, String password, String password2) {
                ...
                if (user != null) {
                    ...
                    myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(mContext, "Registro exitoso. Enviando email de verificación.", Toast.LENGTH_SHORT).show();
