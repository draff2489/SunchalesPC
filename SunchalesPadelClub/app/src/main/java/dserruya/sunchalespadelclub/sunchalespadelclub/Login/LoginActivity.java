...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPleaseWait = (TextView) findViewById(R.id.tv_pleasewait);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isStringNull(email) && isStringNull(password)) {
                    Toast.makeText(mContext, "Debes rellenar todos los campos ", Toast.LENGTH_SHORT).show();
                } else {
                            ...
                            .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(LoginActivity.this, "Autentificación correcta.",
                                        ...
                                        Toast.makeText(LoginActivity.this, "Error en autentificación.",
                                                Toast.LENGTH_SHORT).show();
                                        mProgressBar.setVisibility(View.GONE);
                                        mPleaseWait.setVisibility(View.GONE);
                                        updateUI(null);
