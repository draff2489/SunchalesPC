...
import dserruya.sunchalespadelclub.sunchalespadelclub.Utils.SectionsStatePagerAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private void setupFragments(){
        ...
        pagerAdapter.addFragment(new SignOutFragment(), getString(R.string.log_out_fragment)); //fragment 1
    }
    ...
    private void setupSettingsList(){
        ...
        options.add(getString(R.string.log_out_fragment)); //fragement 1
